...
TMatrix TMatrix::leftSubmatrix(std::vector<int> const& I) const {
...
TMatrix TMatrix::rightSubmatrix(std::vector<int> const& J) const {
...
TMatrix TMatrix::submatrix(std::vector<int> const &I, std::vector<int> const &J) const {
    int r = I.size();
    TMatrix res(r, r, 0.);
